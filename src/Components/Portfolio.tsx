            ...
            <div className='portfolio-content'>
                <div className='row sigma7-row'>
                    <div className='col-lg-6'>
                        <img alt='sigma7 image' className='sigma7-img' src={sigma7} />
                    </div>
                    <div className='col-lg-6'>
                        <h1 className='sigma7-title'>sigma7 <span><img alt='sigma7 logo' style={{width: '20px'}} src={sigma7Logo} /></span></h1>
                ...
                <div className='row coinlink-row'>
                    <div className='col-lg-6'>
                        <h1 className='coinlink-title'><span style={{color: '#0B5AA0'}}>Coin</span><span style={{color: '#DDA04F'}}>Link</span> <span><img alt='coinlink logo' style={{width: '40px', marginBottom: '7px'}} src={coinlinkLogo} /></span></h1>
                    ...
                    <div className='col-lg-6'>
                        <img alt='coinlink image' className='coinlink-img' src={coinlink} />
                    </div>
                </div>
            </div>
        </div>
